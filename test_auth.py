...
tests = [
    ...
    ("[5] Delete (employee)",  "DELETE", "/user/00000000-0000-0000-0000-000000000000", None, emp_token,   403),
    ("[6] RegEmp (no auth)",   "POST",   "/user/register-employee",
     {"phone_number":"+628***e1","email":"e1@t.com","full_name":"N","address":"a"}, None, 401),
    ("[7] RegEmp (admin)",     "POST",   "/user/register-employee",
     {"phone_number":"+6281111111117","email":"e2@t.com","full_name":"A","address":"a"}, admin_token, 201),
    ("[8] RegEmp (employee)",  "POST",   "/user/register-employee",
     {"phone_number":"+628***e3","email":"e3@t.com","full_name":"E","address":"a"}, emp_token, 403),
    ("[9] Update (employee)",  "PUT",    "/user/00000000-0000-0000-0000-000000000000",
